  ...
  <div>
    ...
    <el-card>
      <el-tabs v-model="activeName">
        <!-- Users -->
        <el-tab-pane label="用户" name="first" :lazy="true">
          <!-- Users *** Query -->
        ...
        <!-- Roles -->
        <el-tab-pane label="角色" name="second" :lazy="true">
          <!-- Roles *** Query -->
          <el-card shadow="hover">
        ...
        <!-- Pages -->
        <el-tab-pane label="页面" name="third" :lazy="true">
          <!-- Pages *** Query -->
          <el-card shadow="hover">
        ...
        <!-- Database -->
        <el-tab-pane label="例子" name="fourth" :lazy="true">
          <el-card shadow="hover">
            <el-card>
