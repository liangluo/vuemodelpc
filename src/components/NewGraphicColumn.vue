      ...
      >
        ...
        >
          <el-select
            ...
            @change="selechange"
          >
            <el-option label="单行金刚区" value="单行金刚区"></el-option>
            <el-option label="多行金刚区" value="多行金刚区"></el-option>
          </el-select>
        </el-form-item>
        <br />
...
<script>
// 金刚区栏目
import NewGrapSublumn from "./NewGrapSublumn.vue"
export default {
  name: "NewGraphicColumn",
  data() {
    return {
      imglength: 5, // 最多数量
      dialogForm: {
  ...
  methods: {
    ...
    selechange(item) {
      this.$refs.newpiccolsubimgs.setimgdata();
    }
  }
};
</script>
