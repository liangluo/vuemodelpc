    ...
    <div class="el-dialog-div">
      ...
      >
        ...
        <div class="elformitemsborder">
          ...
          >
            <el-select
              v-model="dialogForm.styledisplay"
              placeholder="请选择展示样式控制"
              @change="selechange"
            >
              <el-option label="大图轮播图" value="大图轮播图"></el-option>
              <el-option label="小图轮播图" value="小图轮播图"></el-option>
              <el-option label="每行多图" value="每行多图"></el-option>
              <el-option label="banner图" value="banner图"></el-option>
            </el-select>
          </el-form-item>
          <br />
          <NewPicColSubImg
            ref="newpicturesulumn"
...
<script>
// 新增/修改图片栏目
import NewPicColSubImg from "./NewPicColSubImg.vue"
export default {
  name: "NewPictureColumn",
  data() {
    return {
      imglength: 10, // 最多数量
      dialogForm: {
  ...
  methods: {
    ...
    selechange(item) {
      this.$refs.newpicturesulumn.setimgdata();
    }
  }
};
</script>
