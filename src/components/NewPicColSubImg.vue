NewGrapSublumn<template>
  <div class="newpiccolsubimg">
    <div class="newpiccolsubimg-sub" v-for="(i, index) in imgdata" :key="index">
      ...
      <p
        v-if="dialogForm.styledisplay"
        style="color: red; margin-left: 120px; font-size: 12px"
      >
        {{
          dialogForm.styledisplay === "大图轮播图"
            ? "支持jpg、png、gif图片，要求小于1M，推荐尺寸：750*680"
            : dialogForm.styledisplay === "小图轮播图"
            ? "支持jpg、png、gif图片，要求小于1M，推荐尺寸：750*360"
            : dialogForm.styledisplay === "每行多图"
            ? "支持jpg、png、gif图片，要求小于1M，推荐尺寸：290*140"
            : dialogForm.styledisplay === "banner图"
            ? "支持jpg、png、gif图片，要求小于1M，图片宽度不超过750"
            : ""
        }}
      </p>
      <br v-if="dialogForm.styledisplay" />
      <el-form-item
        v-if="dialogForm.styledisplay"
        class="elformitems"
        label="绑定内容"
      ...
      <div class="newpiccolsubimg-sub-view" v-if="dialogForm.styledisplay">
